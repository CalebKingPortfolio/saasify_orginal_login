...
flow = Flow.from_client_secrets_file(
    ...
    redirect_uri="http://127.0.0.1:5000/callback"  # Keep this for now if testing inside VM browser
)
...
def callback():
    ...
    # Log the login event with timestamp and IP address
...
if __name__ == "__main__":
    app.run(debug=True, host="0.0.0.0", port=5000)  # Make Flask accessible from outside
import os
import pathlib
import requests
from flask import Flask, render_template, session, redirect, request, abort
